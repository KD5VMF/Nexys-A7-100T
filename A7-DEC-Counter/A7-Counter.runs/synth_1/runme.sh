...
HD_PWD='C:/Users/kd5vm/Downloads/Nexys/A7-Counter_BAK/A7-Counter/A7-Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_seg_top.tcl
