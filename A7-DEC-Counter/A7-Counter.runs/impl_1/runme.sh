...
HD_PWD='C:/Users/kd5vm/Downloads/Nexys/A7-Counter_BAK/A7-Counter/A7-Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_seg_top.tcl -notrace
